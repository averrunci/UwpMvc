...
namespace Charites.Windows.Mvc.Wrappers
{
    ...
    public static class PointerRoutedEventArgsWrapper
    {
        ...
        /// <summary>
        /// Gets a value that indicates whether the pointer event occurred from direct interaction with an object by the user,
        /// or was generated by the platform based on changes to the UI of the application.
        /// </summary>
        /// <param name="e">The requested <see cref="PointerRoutedEventArgs"/>.</param>
        /// <returns><c>true</c> if the event was generated by the platform; otherwise, <c>false</c>.</returns>
        public static bool IsGenerated(this PointerRoutedEventArgs e) => Resolver.IsGenerated(e);
        ...
        private sealed class DefaultPointerRoutedEventArgsResolver : IPointerRoutedEventArgsResolver
        {
            ...
            bool IPointerRoutedEventArgsResolver.IsGenerated(PointerRoutedEventArgs e) => e.IsGenerated;
        }
    }
    ...
    public interface IPointerRoutedEventArgsResolver
    {
        ...
        /// <param name="e">The requested <see cref="PointerRoutedEventArgs"/>.</param>
        /// <returns><c>true</c> if the event was generated by the platform; otherwise, <c>false</c>.</returns>
        bool IsGenerated(PointerRoutedEventArgs e);
    }
}
